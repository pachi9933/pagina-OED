...
class HeaderFour extends Component{
    ...
    render(){
        ...
        if(logo === 'light'){
            ...
            logoUrl = <img src="/assets/images/logo/logo-dark.png" alt="" />;
        }else if(logo === 'symbol-dark'){
            logoUrl = <img src="/assets/images/logo/logo-symbol-dark.png" alt="" />;
        }else if(logo === 'all-dark'){
            logoUrl = <img src="/assets/images/logo/logo-all-dark.png" alt="" />;
                    ...
                    <div className="header-right">
                        <nav className="mainmenunav d-lg-block">
                            <ul className="mainmenu">
                                <li className="has-droupdown"><Link to="/creative-agency">Home</Link>
