                    ...
                    <div className="header-left d-flex align-items-center">
                        ...
                        <nav className="mainmenunav d-lg-block ml--50">
                            <Scrollspy className="mainmenu" items={['home','about','service','portfolio','blog','contact']} currentClassName="is-current" offset={-200}>
                                ...
                                <li className="has-droupdown"><Link to="/gallery" >Investigacion</Link></li>
                                <li className="has-droupdown"><Link to="/columns" >Podcast</Link></li>
                                <li><Link to="#" >Archivo</Link>
                                    <ul className="submenu">
                                        <li><Link to="/testimonial">Articulos</Link></li>
                                        <li><Link to="/clint-logo">Notas</Link></li>
                                        <li><Link to="#">Reseñas</Link></li>
                                        <li><Link to="#">Informes</Link></li>
                                    </ul>
                                </li>
                                <li><Link to="/blog" >Actividades</Link></li> 
                                <li><Link to="/Contact" >Noticias</Link></li>  
