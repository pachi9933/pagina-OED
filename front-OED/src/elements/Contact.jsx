                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="rn-page-title text-center pt--100">
                                    <h2 className="title theme-gradient">Contactenos</h2>
                                    <p>Si tenes sugerencias dudas, nuevas ideas o queres participar</p>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                                <div className="rn-address">
                                    ...
                                    <div className="inner">
                                        <h4 className="title">Telefonos</h4>
